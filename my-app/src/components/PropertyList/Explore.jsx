...
const Explore = () => {
  return (
    <div className='flex flex-col  w-full max-w-[800px] xl:max-w-[1800px] 2xl:max-w-[1800px] gap-[20px]'>
      ...
      <section className='  hide-scrollbar flex w-full items-start justify-start gap-8 overflow-x-auto flex-col 2xl:flex-row xl:flex-row  '>
        ...
        <div className='rounded-lg cursor-pointer overflow-hidden w-[600px] flex-shrink-0 zoom-container'>
          ...
          <div className='cursor-pointer p-2'>
            <h1 className='text-[30px] font-bold'>Essouira</h1>
          </div>
        </div>
        <div className='rounded-lg cursor-pointer overflow-hidden w-[600px] flex-shrink-0 zoom-container'>
        ...
        <div className='ounded-lg cursor-pointer overflow-hidden w-[600px] flex-shrink-0 zoom-container'>
          <img className='w-full h-[400px] object-cover' src="/kh.jpg" alt="Resorts" />
          <div className='cursor-pointer p-2'>
            <h1 className='text-[30px] font-bold'>Khouribga</h1>
          </div>
        </div>
        <div className='rounded-lg cursor-pointer overflow-hidden w-[600px] flex-shrink-0 zoom-container'>
          <img className='w-full h-[400px] object-cover' src="/rb.jpg" alt="Cabins" />
          <div className='cursor-pointer p-2'>
            <h1 className='text-[30px] font-bold'>Rabat</h1>
          </div>
        </div>
