                            ...
                            {openOptions && <div className='absolute top-[60px] text-gray-500 rounded-lg' style={{background: '#f0efef'}}>
                                 <div className='flex justify-between m-[10px]'>
                                     ...
                                     <div className='flex items-center gap-10 text-lg'>
                                         <button disabled={option.children <= '1'} onClick={() => optionCounter("adult", "De")}className='w-[50px] h-[50px] rounded-lg' style={{background: '#b8b8b8', color: '#003580', border : '1px solid #003580'}}>-</button>
                                 ...
                                 <div className='flex justify-between gap-10 m-[10px]'>
                                     ...
                                     <div className='flex items-center gap-10 text-lg'>
                                         <button disabled={option.children <= '1'} onClick={()=> optionCounter("children", "De")} className='w-[50px] h-[50px] rounded-lg' style={{background: '#b8b8b8', color: '#003580', border : '1px solid #003580'}}>-</button>
                                 ...
                                 <div className='flex justify-between m-[10px]'>
                                     ...
                                     <div className='flex items-center gap-10 text-lg'>
                                         <button disabled={option.children <= '1'} onClick={()=>optionCounter("room", "De")} className='w-[50px] h-[50px] rounded-lg ' style={{background: '#b8b8b8', color: '#003580', border : '1px solid #003580'}} >-</button>
